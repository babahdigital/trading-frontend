...
const COPY = {
  id: {
    ...
    body: 'Portal mengalami gangguan saat memproses permintaan Anda. Tim kami otomatis mendapat notifikasi.',
    error_id_label: 'Error ID',
    cta_retry: 'Coba Lagi',
    cta_portal: 'Kembali ke Portal',
    support_pre: 'Hubungi',
  ...
  en: {
    ...
    body: 'The portal encountered an issue while processing your request. Our team has been automatically notified.',
    error_id_label: 'Error ID',
    cta_retry: 'Try Again',
    cta_portal: 'Back to Portal',
    support_pre: 'Contact',
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto mt-4">
        ...
        >
          <ArrowLeft className="h-4 w-4" /> {copy.cta_portal}
        </Link>
      </div>
