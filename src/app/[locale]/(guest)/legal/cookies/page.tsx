        ...
        <section className="section-padding">
          <div className="container-default px-4 sm:px-6">
            ...
            <div className="container-prose space-y-10 text-foreground/60" style={{ lineHeight: 1.7 }}>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">1. What Are Cookies</h2>
                <p>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">2. Cookies We Use</h2>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">3. Third-Party Cookies</h2>
                <p>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">4. Managing Cookies</h2>
                <p>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">5. Updates to This Policy</h2>
                <p>
              ...
              <section>
                <h2 className="t-display-sub mb-6 text-foreground">6. Contact</h2>
                <p>
