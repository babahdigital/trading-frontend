    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-[720px] mx-auto px-6 py-20" style={{ lineHeight: 1.7 }}>
        ...
        <div className="space-y-10 text-muted-foreground">
          ...
          {/* Data Collection */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">1. Data Collection</h2>
          ...
          {/* Usage */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">2. How We Use Your Data</h2>
          ...
          {/* Storage */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">3. Data Storage and Retention</h2>
            <p>
          ...
          {/* Third Parties */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">4. Third-Party Sharing</h2>
            <p>
          ...
          {/* Cookies */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">5. Cookies and Tracking</h2>
            <p>
          ...
          {/* User Rights */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">6. Your Rights</h2>
          ...
          {/* Data Security */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">7. Data Security</h2>
            <p>
          ...
          {/* Changes */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">8. Changes to This Policy</h2>
            <p>
          ...
          {/* Contact */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">9. Contact</h2>
            <p>
              For questions or concerns regarding this Privacy Policy or our data practices, contact us at:
            </p>
            <div className="mt-4 border border-border rounded-lg p-6 bg-card text-sm">
