    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-[720px] mx-auto px-6 py-20" style={{ lineHeight: 1.7 }}>
        ...
        <div className="space-y-10 text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">1. General Risk Warning</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">2. Leverage Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">3. Market Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">4. Algorithmic and Systematic Trading Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">5. Past Performance</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">6. Counterparty and Broker Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">7. Liquidity Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">8. Regulatory and Legal Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">9. PAMM and Managed Account Risk</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">10. Acknowledgment</h2>
            <p>
