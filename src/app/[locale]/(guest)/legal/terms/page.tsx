    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-[720px] mx-auto px-6 py-20" style={{ lineHeight: 1.7 }}>
        ...
        <div className="space-y-10 text-muted-foreground">
          ...
          {/* 2. Eligibility */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">2. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">3. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">4. Subscription Plans and Services</h2>
            <p>
          ...
          {/* 5. Billing */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">5. Billing and Payment</h2>
            <p>
          ...
          {/* 6. Cancellation */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">6. Cancellation and Refunds</h2>
            <p>
          ...
          {/* 7. IP */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">7. Intellectual Property</h2>
            <p>
          ...
          {/* 9. Governing Law */}
          <section>
            <h2 className="font-display text-xl font-semibold text-foreground mb-4">9. Governing Law and Dispute Resolution</h2>
            <p>
