          ...
          <div className="border border-border rounded-lg p-8 bg-card mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="border border-border rounded-lg p-8 bg-background text-center">
                <p className="font-mono text-lg text-accent mb-1">15 min</p>
                <p className="text-xs text-muted-foreground">Analysis cycle</p>
              </div>
              <div className="border border-border rounded-lg p-8 bg-background text-center">
                <p className="font-mono text-lg text-accent mb-1">14 pairs</p>
                <p className="text-xs text-muted-foreground">Monitored instruments</p>
              </div>
              <div className="border border-border rounded-lg p-8 bg-background text-center">
                <p className="font-mono text-lg text-accent mb-1">0-100</p>
          ...
          <div className="border border-border rounded-lg p-8 bg-card mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              <div className="border border-border rounded-lg p-8 bg-background text-center">
                ...
                <p className="text-xs text-muted-foreground">Bridge latency</p>
              </div>
              <div className="border border-border rounded-lg p-8 bg-background text-center">
                <p className="font-mono text-lg text-accent mb-1">TCP/localhost</p>
                <p className="text-xs text-muted-foreground">Transport protocol</p>
              </div>
            </div>
          </div>
