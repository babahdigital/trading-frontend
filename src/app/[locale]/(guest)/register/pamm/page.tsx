        ...
        <section className="section-padding border-b border-white/8">
          <div className="container-default px-6">
            <div className="max-w-md mx-auto">
              ...
              <h1 className="t-display-sub mb-2">PAMM Account Registration</h1>
              <p className="t-lead text-foreground/60 mb-10">
                Professional managed account with profit sharing.
              </p>
                    ...
                    <>
                        ...
                        {[
                          {
                            value: 'PAMM_BASIC',
                            label: 'PAMM Basic',
                            share: '20% profit share',
                            desc: 'Minimum deposit $500',
                          },
                          {
                            value: 'PAMM_PRO',
                            label: 'PAMM Pro',
                            share: '30% profit share',
                            desc: 'Minimum deposit $5,000, priority support',
                          },
                        ].map((tier) => (
                          <div
                            key={tier.value}
                          ...
                          >
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-amber-400 font-mono font-bold">{tier.share}</span>
                            </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => set('mt5Account', e.target.value)}
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          onClick={() => setStep(2)}
                          disabled={!form.broker || !form.mt5Account}
                        >
                          Continue
                        </button>
                      </div>
                      ...
                      <div className="border border-white/8 rounded-lg p-4 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-amber-400">
                            {form.tier === 'PAMM_BASIC' ? 'PAMM Basic (20%)' : 'PAMM Pro (30%)'}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-foreground/60">Broker</span>
                          <span>{form.broker}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-foreground/60">MT5 Account</span>
                          <span className="font-mono">{form.mt5Account}</span>
                        </div>
                      </div>
                      {error && (
