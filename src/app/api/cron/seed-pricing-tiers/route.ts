...
const CANONICAL_TIERS: CanonicalTier[] = [
  ...
  // VPS LICENSE
  {
    slug: 'vps-standard', name: 'Software License', name_en: 'Software License',
    price: '$3,000 setup + $150/bulan',
    subtitle: 'Software terinstal di VPS pribadi Anda — kontrol penuh',
    subtitle_en: 'Software installed on your private VPS — full control',
  ...
  {
    slug: 'vps-premium', name: 'Software License Pro', name_en: 'Software License Pro',
    price: '$7,500 setup + $300/bulan',
    subtitle: 'Multi-broker, multi-akun, priority technical support',
    subtitle_en: 'Multi-broker, multi-account, priority technical support',
