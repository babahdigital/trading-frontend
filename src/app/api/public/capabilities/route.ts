...
const FALLBACK: CapabilitiesResponse = {
  ...
  strategies: [
    { name: 'scalper.qm_perfect_adx', category: 'strategy', available_in_tier: 'starter', description: 'QM + ADX trend-filtered scalper' },
    { name: 'scalper.qm_perfect_ao', category: 'strategy', available_in_tier: 'starter', description: 'QM + Awesome Oscillator momentum scalper' },
    { name: 'scalper.qm_perfect_full', category: 'strategy', available_in_tier: 'starter', description: 'QM full confluence multi-indicator' },
    { name: 'scalper.pivot_mean_reversion', category: 'strategy', available_in_tier: 'starter', description: 'Daily pivot mean reversion' },
    { name: 'swing.qm_perfect_pure', category: 'strategy', available_in_tier: 'pro', description: 'SMC Swing pure Quasimodo pattern' },
    { name: 'swing.qm_perfect_full', category: 'strategy', available_in_tier: 'pro', description: 'SMC Swing full confluence' },
    { name: 'quad_confluence', category: 'strategy', available_in_tier: 'pro', description: 'AMD + FVG quad-factor convergence' },
    { name: 'scalper.qm_perfect_adx_h4', category: 'strategy', available_in_tier: 'vip', description: 'QM ADX H4-tuned higher timeframe' },
  ],
  ai_subsystems: [
