...
const STATIC_PAGES: { path: string; priority: number; changeFrequency: 'always' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'yearly' | 'never' }[] = [
  ...
  { path: '/platform/strategies/pivot-mean-reversion', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/solutions/signal', priority: 0.8, changeFrequency: 'weekly' },
  { path: '/solutions/crypto', priority: 0.8, changeFrequency: 'weekly' },
  { path: '/solutions/license', priority: 0.7, changeFrequency: 'weekly' },
