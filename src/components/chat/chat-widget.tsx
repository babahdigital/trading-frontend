...
const COPY: Record<'id' | 'en', CopyBundle> = {
  id: {
    ...
    greeting:
      'Halo! Saya Babah — asisten AI BabahAlgo. Saya bisa bantu jelaskan layanan Robot Meta (Forex MT5), Robot Crypto (Binance), pricing tier, konsep SMC/Wyckoff, kerangka risiko 12 layer, atau alur onboarding KYC. Ada yang ingin ditanyakan?',
    ...
    quick_replies: [
      ...
      { label: 'Risk 12-Layer', message: 'Jelaskan kerangka risiko 12 layer Robot Meta secara ringkas.' },
  ...
  en: {
    ...
    status_offline: 'Offline',
    greeting:
      "Hi! I'm Babah — BabahAlgo's AI assistant. I can walk you through Robot Meta (Forex MT5), Robot Crypto (Binance), pricing tiers, SMC/Wyckoff concepts, the 12-layer risk framework, or our KYC onboarding flow. What would you like to know?",
    ...
    quick_replies: [
      ...
      { label: '12-Layer Risk', message: 'Explain the 12-layer risk framework of Robot Meta briefly.' },
