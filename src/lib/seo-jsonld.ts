...
export function organizationSchema() {
  return {
    ...
    description: 'Quantitative trading infrastructure: Forex MT5 algorithmic execution (4 core strategies — SMC Scalper, SMC Swing, Pivot Mean Reversion, Quad Confluence — executed by deterministic decision engine with adaptive math risk modules) + Binance Spot/Futures crypto bot, institutional-grade with zero-custody positioning.',
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'ID',
    },
